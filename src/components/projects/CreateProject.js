...
const CreateProject = () => {
    ...
    const [numberOfSamples, setNumberOfSamples] = useState(132)
    ...
    const handleFolderChange = (e) => {
        ...
        const newNumberOfSamples = folderDict[folder]["objects"].length
        setNumberOfSamples(newNumberOfSamples)

        form.setFieldsValue({
            emotions_per_survey: newNumberOfEmotions,
            samples_per_survey: newNumberOfSamples
        });
    ...
    return (
        <div>
            ...
            <Form
                ...
                <Form.Item
                    label="No. samples per survey"
                    name="samples_per_survey"
                >
                    <NumberOfSamplesSlider numberOfSamples={numberOfSamples} onValueChange={handleNumberOfSamplesChange}/>
                </Form.Item>
